...
sed -i "s|workshop-state-store|$kssname|g" /home/ec2-user/environment/kopsconfig.yaml
sed -i "s|configbasestring|$kssname/$KOPSNAME|g" /home/ec2-user/environment/kopsconfig.yaml
